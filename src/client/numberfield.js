...
module.exports = class Component extends react.Component{
	...
	render(){
		return react.createElement(Input,{type:"text",value:this.text,onChange:this.onChange.bind(this),onBlur:this.onBlur.bind(this),errors:this.props.errors,className:this.props.className});
	}
	onBlur(){
